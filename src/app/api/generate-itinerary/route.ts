...
export async function POST(request: Request) {
    ...
    try {
        ...
        const extractorModel = genAI.getGenerativeModel({ model: 'gemini-2.5-flash' }, { apiVersion: 'v1beta' });
...
${extractedText.substring(0, 30000)}
        ...
        const itineraryModel = genAI.getGenerativeModel({ model: 'gemini-2.5-flash' }, { apiVersion: 'v1beta' });
