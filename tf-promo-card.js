class TfPromoCard extends HTMLElement {
  ...
  render() {
    ...
    const clickableStart = item.link ? `<a class="card ${themeClass} ${formatClass}" href="${item.link}" target="_self" rel="noopener">` : `<div class="card ${themeClass} ${formatClass}">`;
...
/* Formatos */
.format-banner .image img { width: 100%; height: auto; }

/* Tema dark (overlay sobre imagem) */
.theme-dark .overlay {
